...
namespace UHF { 
    public static class RWDev
    {
        ...
        [DllImport(DLLNAME, CallingConvention = CallingConvention.StdCall)]
        public static extern int GetReaderInformation(ref byte ComAdr,              //판독기 주소
                                                      byte[] VersionInfo,           //소프트웨어 버전
                                                      ref byte ReaderType,              //판독기 모델
                                                      ref byte TrType,      //지원되는 협의
                                                      ref byte dmaxfre,           //현재 판독기가 사용하는 최대 주파수
                                                      ref byte dminfre,           //현재 판독기가 사용하는 최소 주파수
                                                      ref byte powerdBm,             //판독기 출력
                                                      ref byte ScanTime,
								                      ref byte Ant,
								                      ref byte BeepEn,
								                      ref byte OutputRep,
